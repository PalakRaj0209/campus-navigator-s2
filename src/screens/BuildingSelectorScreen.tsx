...
export default function BuildingSelectorScreen() {
  ...
  const [campus, setCampus] = useState('Sarala Birla University ');
  const [selectedBuilding, setSelectedBuilding] = useState('Pharmacy Block');
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.pickerWrapper}>
          ...
          >
            <Picker.Item label="Sarala Birla University " value="Sarala Birla University " />
        ...
        <View style={styles.pickerWrapper}>
          <Picker
            ...
            dropdownIconColor="#6366f1"
          >
            <Picker.Item label="Pharmacy Block" value="Pharmacy Block" />
